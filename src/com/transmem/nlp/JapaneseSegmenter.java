...
/**
 * Implements the ISegmenter interface to break a Japanese sentence into separate words.
 ...
 */
public class JapaneseSegmenter implements ISegmenter
{
	public static final Logger log_ = Logger.getLogger(JapaneseSegmenter.class.getName());
	...
	public String[] segment(String sent) throws LanguageException
	{
		...
		try
		{
			//TODO: CJKAnalyzer cannot break Japanese characters into meaningful words!
