...
/**
 * Chinese word index for English-Chinese sentences
 *
 * @version 0.1
 * @author Ted Wen
 * @date Jan.2007
 */
public class ZHENX implements java.io.Serializable
{
	protected static final long serialVersionUID = 107L;
	private Logger log_ = Logger.getLogger(ZHENX.class.getName());

	private boolean[] setreg_ = new boolean[3];

	private Connection con_;
	private String word_; ///Chinese word as index
	private long sid_; ///Sentence ID
	private short offset_; ///Which word in the target sentence

	/**
	 * Construct an empty ZHENX object.
	 *
	 */
	public ZHENX()
	{
	...
	/**
	 * Construct a ZHENX object with a Connection instance.
	 *
	 * @param con - Connection object
	 */
	public ZHENX(Connection con)
	{
		con_ = con;
	}
	 ...
	 *
	 */
	public ZHENX(Connection con, String _word, long _sid) throws SQLException
	{
		con_ = con;
	...
	public void queryByPrimaryKey(String _word, long _sid) throws SQLException
	{
		...
		String sql = "select * from T_ZHENX where F_Word=? AND F_SID=?";
	...
	{
		String sql = "select * from T_ZHENX where F_Word=?";
		PreparedStatement stmt = null;
		ResultSet rs = null;
		try
		{
	...
	public void delete(String _word, long _sid) throws SQLException
	{
		...
		String sql = "delete from T_ZHENX where F_Word=? AND F_SID=?";
		PreparedStatement stmt = null;
		try
		{
			stmt = con_.prepareStatement(sql);
